...
window.addEventListener("load", function () {
  ...
  testimonialsContent.forEach((testimonial) => {
    ...
    <div class="testimonial">
      <figure class="testimonial-author" data-id='${testimonial.id}'>
        <figcaption>
          <h3 class="testimonial-name">${testimonial.customerName}</h3>
          <p class="testimonial-location">${testimonial.country}.</p>
